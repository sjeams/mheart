        ...
        <table class="table table-bordered chat_footer " >
            ...
            <td class="btn-primary  friend_input" >
                ...
                <td class="btn-primary friend_search" style="max-width: 100px!important;" >
                    <span class="btn  " onclick="gou_search()" style="min-width: 32px!important;" ><i class="bi bi-search"></i> </span>  
                    <!-- <span class="btn  "><i class="bi bi-plus-circle"></i> </span> -->
                   <a href="/cn/chat/list"><span class="btn  " style="min-width: 32px!important;"> <i class="bi bi-person-lines-fill"></i></span></a> 
                </td>
            </tr>

...
<?php   foreach($content as $kss => $v) { ?>
        ...
        <tr>
            <td class="remove_<?php echo $v['id']?> p-0">
                ...
                <p class="center"  onclick="downloadUrl(<?php echo $v['id']?>)"><span ><b>P<?php echo (($data['page']-1) ) ?>-<?php echo ( (($data['page']-1)*10 )+($kss+1)) ?>、</b></span> <?php echo  $search_title ? str_replace($search_title,"<span class='red'> $search_title </span> ",$v['title']) : $v['title']?></p>
                <p class="center">

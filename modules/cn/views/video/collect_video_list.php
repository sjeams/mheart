    ...
    foreach($content as $kss => $v) {
        ...
        <tr>
            <td class="remove_<?php echo $v['id']?> p-0">
                ...
                <!-- </a> -->
                <p class="center">
                    <span style="width: 48%!important;max-width:210px" onclick="videoList(<?php echo $v['id']?>)" class="btn btn-success collect"> 重播 </span>
                    <span style="width: 48%!important;max-width:210px" onclick="Update_my(<?php echo $v['id']?>)" class="btn btn-danger collect my_collect_<?php echo $v['id']?> "> 移除</span>
                </p>
            </td>
        </tr>
        <?php

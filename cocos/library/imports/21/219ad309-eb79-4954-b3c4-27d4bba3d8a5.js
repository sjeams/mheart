...
// Script/背包/biology_iconTools.js
...
cc.Class({
  ...
  biology_detail_alert: function biology_detail_alert() {
    ...
    var TipBoxPrefab = cc.instantiate(http_globalAsset.model_home_biology_detail_heard); //技能等级
  ...
  biology_detail_list: function biology_detail_list(TipBoxPrefab, info_list) {
    ...
    for (var prop in info_list) {
      var info = TOOLS[prop];
      var TipBoxPrefab_icon = cc.instantiate(http_globalAsset.model_home_biology_detail_heard_icon);
      TipBoxPrefab_icon.getChildByName('P头像').getComponent(cc.Sprite).spriteFrame = http_globalAsset.http_base_asset_biology[info.picture]; //技能等级

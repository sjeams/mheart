...
// Script/fighting/biology_detailTools.js
...
cc.Class({
  ...
  biology_detail_alert: function biology_detail_alert(BoxPrefab, info, biology_image) {
    ...
    cc.loader.loadRes('/model弹窗/biology_生物_战斗详情', function (errorMessage, loadedResource) {
      ...
      _this.biology_detail_info(BoxPrefab, TipBoxPrefab, info, biology_image); //将预制资源添加到父节点
      // CanvasNode.addChild(TipBoxPrefab);

    });
  },
  biology_detail_info: function biology_detail_info(BoxPrefab, TipBoxPrefab, info, biology_image) {
    var _this = this;

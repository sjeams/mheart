...
var httpFightingExtend = cc.Class({
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", new Promise(function (resolve) {
                cc.find('Canvas/大厅/time').runAction(cc.sequence(cc.scaleTo(0.3, 2, 2), cc.scaleTo(0.3, 1, 1), cc.delayTime(_this.sudu(0.5)), cc.callFunc(function () {
                  resolve();
                }, _this2))); //建一个缩放到1.5倍大小的动作，持续时间2秒
              }));
  ...
  playTips: function playTips(node, biology, is_skill) {
    ...
    if (biology.descript_go_msg != '') {
      ...
      node.getChildByName('技能背景').opacity = 255; // node.getChildByName('技能背景').runAction( cc.sequence(cc.fadeIn(_this.sudu(0.01)),cc.scaleTo(_this.sudu(0.1), 1.2, 1.2),cc.delayTime(_this.sudu(0.5)),cc.scaleTo(_this.sudu(0.3), 1, 1),cc.fadeOut(0.1),cc.moveBy(_this.sudu(0.01),cc.v2(0,0)),cc.callFunc(function(){  node.getChildByName('技能背景').active=false;  },this)));
  ...
  playReady: function playReady(node, biology) {
    ...
    if (biology.extend == 'wuXingTotal') {
      ...
      node.getChildByName('悟性动作').opacity = 255; // node.getChildByName('悟性动作').runAction(cc.sequence(cc.fadeIn(_this.sudu(0.01)),cc.scaleTo(0.3, 1.2, 1.2),cc.fadeOut(0.5),cc.scaleTo(_this.sudu(0.1), 1, 1),cc.callFunc(function(){  node.getChildByName('悟性动作').active=false  
      // },this)));
      ...
      if (wuxing_floor > 0) {
        ...
        if (parseInt(xingxing) != wuxing_floor) {
          ...
          node.getChildByName('悟性星星s').getComponent(cc.Label).string = 'X' + wuxing_floor; // node.getChildByName('悟性星星s').runAction(cc.sequence(cc.fadeIn(_this.sudu(0.01)),cc.scaleTo(_this.sudu(0.1), 1.2, 1.2),cc.delayTime(_this.sudu(0.5)),cc.scaleTo(_this.sudu(0.3), 1, 1),cc.callFunc(function(){   },this))); 
          ...
          _this.actionBlink_show(node.getChildByName('悟性星星')); // _this.actionBlink_show(node.getChildByName('悟性星星s'))
  ...
  actionMdel: function actionMdel(move_node, hurt_msg) {
    ...
    var actionhiddenBig = cc.spawn(cc.moveBy(_this.sudu(0.5), cc.v2(0, -40)), cc.scaleTo(_this.sudu(0.5), 1, 1), cc.delayTime(_this.sudu(0.5)), cc.fadeOut(_this.sudu(0.5)));
    move_node.runAction(cc.sequence(actionhiddenSmoll, cc.delayTime(_this.sudu(0.5)), actionhiddenBig, cc.callFunc(function () {
      move_node.active = false;
    }, this)));
  },
  // 隐藏
  actionBig: function actionBig(move_node) {
    var _this = this;

    var actionhiddenSmoll = cc.spawn(cc.fadeIn(_this.sudu(0.01)), cc.scaleTo(_this.sudu(0.2), 1.5, 1.5));
    var actionhiddenBig = cc.spawn(cc.scaleTo(_this.sudu(0.5), 1, 1), cc.delayTime(_this.sudu(0.5)), cc.fadeOut(_this.sudu(0.5)));
    move_node.runAction(cc.sequence(actionhiddenSmoll, cc.delayTime(_this.sudu(0.5)), actionhiddenBig, cc.callFunc(function () {
      move_node.active = false;
    }, this)));
  },
  //显示
  actionBig_show: function actionBig_show(move_node) {
    var _this = this;

    var actionhiddenSmoll = cc.spawn(cc.fadeIn(_this.sudu(0.01)), cc.scaleTo(_this.sudu(0.2), 1.5, 1.5));
    var actionhiddenBig = cc.spawn(cc.scaleTo(_this.sudu(0.5), 1, 1), cc.delayTime(_this.sudu(0.5)));
    move_node.runAction(cc.sequence(actionhiddenSmoll, cc.delayTime(_this.sudu(0.5)), actionhiddenBig, cc.callFunc(function () {}, this)));
  },
  // 血条
  actionProgressBar: function actionProgressBar(progressBar, hurt_go_value, shengMing) {
    progressBar.progress = hurt_go_value / shengMing;
    progressBar.completeCount = hurt_go_value;
    progressBar.totalCount = shengMing;
  },
  actionMdelProgressBar: function actionMdelProgressBar(move_node, hurt_msg, progressBar, hurt_go_value, shengMing) {
    var _this = this;
    ...
    var actionhiddenBig = cc.spawn(cc.moveBy(_this.sudu(0.5), cc.v2(0, -40)), cc.scaleTo(_this.sudu(0.5), 1, 1), cc.delayTime(_this.sudu(0.5)), cc.fadeOut(_this.sudu(0.5)));
    move_node.runAction(cc.sequence(actionhiddenSmoll, cc.delayTime(_this.sudu(0.5)), actionhiddenBig, cc.callFunc(function () {
      _this.actionProgressBar(progressBar, hurt_go_value, shengMing);

      move_node.active = false;
    }, this)));
  },
  //重复闪烁
  actionBlink_show: function actionBlink_show(move_node) {
    var _this = this; // 创建旋转动作，这里以每秒绕X轴旋转360度为例


    var rotateAction = cc.rotateBy(1, 360); // const rotateAction = cc.blink(1,1)
  ...
  playMove: function playMove(node, biology, is_skill) {
    ...
    if (biology.extend == 'moFa') {
      ...
      var progressBar = node.getChildByName('魔法').getComponent(cc.ProgressBar); //  耗蓝为0跳过0跳过
    ...
    if (biology.extend == 'shengMing') {
      ...
      var progressBar = node.getChildByName('生命').getComponents(cc.ProgressBar); // progressBar.progress = biology.hurt_go_value / node.shengMing
      ...
      if (biology.hurt_go >= 0) {
        ...
        node.getChildByName('受伤').runAction(cc.fadeOut(_this.sudu(1)), cc.callFunc(function () {
  ...
  //准备动作--变大
  buttonSkill: function buttonSkill(node, biology, is_skill) {
    var _this4 = this;
          ...
          switch (_context3.prev = _context3.next) {
            case 0:
              return _context3.abrupt("return", new Promise(function (resolve) {
                ...
                var actionhiddenBig = cc.spawn(cc.scaleTo(_this.sudu(0.5), 1.2, 1.2), cc.delayTime(_this.sudu(0.6)), cc.callFunc(function () {
                ...
                var actionhiddenSmoll = cc.spawn(cc.scaleTo(_this.sudu(0.5), 1, 1), cc.delayTime(_this.sudu(0.6)), cc.callFunc(function () {// //等待攻击完成
                }, _this4)); //变大还原
                // cc.spwan( 同时完成

                node.runAction(cc.sequence(actionhiddenBig, actionhiddenSmoll, // 执行动作完成之后调用的方法
  ...
  //准备动作--变大
  buttonReady: function buttonReady(node, biology, is_skill) {
    var _this5 = this;
          ...
          switch (_context4.prev = _context4.next) {
            case 0:
              return _context4.abrupt("return", new Promise(function (resolve) {
                ...
                var actionhiddenBig = cc.spawn(cc.blink(_this.sudu(_this.sudu(0.2)), 20), cc.scaleTo(_this.sudu(0.3), 1.2, 1.2), cc.delayTime(_this.sudu(0.6)), cc.callFunc(function () {
                  // //等待攻击完成
                  _this.playReady(node, biology);
                ...
                var actionhiddenSmoll = cc.spawn(cc.scaleTo(_this.sudu(0.5), 1, 1), cc.delayTime(_this.sudu(0.6))); //变大还原
                // cc.spwan( 同时完成
  ...
  //移动
  buttonMove: function buttonMove(node, m_node, biology, is_skill) {
    var _this6 = this;

    return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
      var _this, arr, m_x, m_y, m_x_move, actionLeft, actionRight;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              actionLeft = cc.spawn(cc.moveBy(_this.sudu(0.3), cc.v2(m_x, m_y)), cc.scaleTo(_this.sudu(0.3), 1.2, 1.2), cc.delayTime(_this.sudu(0.6)), cc.callFunc(function () {
                //等待攻击完成  
              ...
              }, _this6)); // const actionWaite = cc.delayTime(_this.sudu(0.1)) 
              //返回位置

              actionRight = cc.spawn(cc.moveBy(_this.sudu(0.3), cc.v2(-m_x, -m_y)), cc.scaleTo(_this.sudu(0.3), 1, 1), cc.delayTime(_this.sudu(0.6)), cc.callFunc(function () {// //等待攻击完成
              }, _this6)); // 让节点在向上移动的同时缩放
              // arr.push(cc.scaleTo(_this.sudu(0.1), 1,1))

              return _context5.abrupt("return", new Promise(function (resolve) {
                node.runAction(cc.sequence(actionLeft, actionRight, cc.callFunc(function () {
                  resolve();
                })));
              }));
  ...
  buttonMoveOut: function buttonMoveOut(node, biology) {
    ...
    if (biology.position_my == 1) {
      ...
      cc.callFunc(function () {// _this.schedule(function(){

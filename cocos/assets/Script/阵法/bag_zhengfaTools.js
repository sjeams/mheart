...
cc.Class({
    ...
    // onLoad () {},
     //查看生物详情_弹窗
    biology_detail_alert(BoxPrefab,TipBoxPrefab_model) {
        this.biology_detail_info(BoxPrefab,TipBoxPrefab_model)
    },
    biology_detail_info(BoxPrefab,TipBoxPrefab_model) {
        ...
        cc.loader.loadRes('/model布阵/背包生物', function(errorMessage,loadedResource_icon){
            ...
            TipBoxPrefab_model.getComponent('bag_zhengfa头像Tools').biology_detail_list(TipBoxPrefab_model,TipBoxPrefab,biology)
